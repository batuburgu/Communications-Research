...
% Plot
figure;
semilogy(gamma_bar_db, outage_probability(1,:), '-*', 'LineWidth', 1.4, 'MarkerSize', 5); hold on;
semilogy(gamma_bar_db, outage_probability(2,:), '-*', 'LineWidth', 1.4, 'MarkerSize', 5);
...
grid on;
box on;
set(gca, 'FontSize', 12);  % Eksen fontları
...
title('Fig. 5: Outage Probability for Single THz Links ($d = 50$ m)', ...
